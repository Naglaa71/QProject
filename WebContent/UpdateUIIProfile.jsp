...
<body onload="alternate('myTable')">
	...
	<s:form action="ConfirmUpdateProfileAction">
		...
		<table id="myTable" align="center" width="600" border="1" summary="header links">
			...
			<br />
				...
				<td><s:textfield  id="zipCodeExt" label="Audit Office Zip Code Extension  " name="auditFirm.audit_firm_zip_code_ext" style="width: 40px;" onkeyleave="checkNumeric('zipCodeExt')"/></td>
