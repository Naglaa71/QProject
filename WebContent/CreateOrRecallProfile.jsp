...
<title>Create A New Profile Or Recall An Existing Profile</title>
<style type="text/css">
.errorMessage {
	color: red;
}
...
<body>
	...
	<s:form action="CreateOrRecallAction">
		<table align="center" width="600" border="0" summary="header links">
			<br />
			<br />
			<strong>Please enter your office EIN and ZIP Code below and
