...
public class CreateOrRecallAction extends ActionSupport implements  SessionAware{
	...
	public String execute() throws Exception {
		...
		AuditFirm myAuditFirm = (new AuditFirm()).getAuditFirmObject(this.getAudit_firm_tax_id(), this.getAudit_firm_zip_code());
		...
		if (this.getAuditFirm().getAudit_firm_id() == null ){
			...
			this.setAuditFirm(myAuditFirm);
			myAuditFirm.getStates().add("");
			this.setStates(myAuditFirm.getStates());
			this.getAuditFirm().setAudit_firm_state("00");
			return SUCCESS;
		}else
		{
