...
public class AuditFirm {
	...
	public AuditFirm getAuditFirmObject(String auditTaxId, String auditZipCode) throws Exception{
		...
		try {
			...
			if ( myResult > 0 )
			{
				...
				this.setAudit_firm_phone_num(pstmt.getString(11));
				...
				this.setAuditor_contact_phone_num(pstmt.getString(16));
				this.setAuditor_contact_phone_ext_num(pstmt.getString(17));
				this.setAuditor_contact_fax_num(pstmt.getString(18));
...
public AuditFirm getAuditFirmObject4(String auditId,String auditTaxId, String auditZipCode) throws Exception{
	...
	try {
		conn = (new DBConnection()).getConnection();
		pstmt = conn.prepareCall("{call qass_get_audit_firm_info4(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
		
				pstmt.setString(1,auditId);		 
				pstmt.setString(2,auditTaxId);
				pstmt.setString(3,auditZipCode);
				pstmt.registerOutParameter(4, Types.CHAR);
				pstmt.registerOutParameter(5, Types.VARCHAR);
				pstmt.registerOutParameter(6, Types.CHAR);
				pstmt.registerOutParameter(7, Types.VARCHAR);
				pstmt.registerOutParameter(8, Types.VARCHAR);
				pstmt.registerOutParameter(9, Types.VARCHAR);
				pstmt.registerOutParameter(10, Types.CHAR);
				pstmt.registerOutParameter(11, Types.CHAR);
				pstmt.registerOutParameter(12, Types.VARCHAR);
				pstmt.registerOutParameter(13, Types.VARCHAR);
				pstmt.registerOutParameter(14, Types.VARCHAR);
				pstmt.registerOutParameter(15, Types.VARCHAR);
				...
				pstmt.registerOutParameter(19, Types.VARCHAR);
				pstmt.registerOutParameter(20, Types.VARCHAR);  
				pstmt.registerOutParameter(21, Types.CHAR);
				pstmt.registerOutParameter(22, Types.VARCHAR);
				
				 int myResult = pstmt.executeUpdate();
		 	 
			if ( myResult > 0 )
			{
				this.setAudit_firm_id(auditId);
				this.setAudit_firm_tax_id(auditTaxId);
				this.setAudit_firm_zip_code(auditZipCode);
				this.setAudit_firm_name(pstmt.getString(5));
				this.setAudit_firm_type(pstmt.getString(6));
				this.setAudit_firm_address_line_1(pstmt.getString(7));
				this.setAudit_firm_address_line_2(pstmt.getString(8));
				this.setAudit_firm_city(pstmt.getString(9));
				this.setAudit_firm_state(pstmt.getString(10));
				this.setAudit_firm_zip_code_ext(pstmt.getString(11));
				this.setAudit_firm_phone_num(pstmt.getString(12));
				this.setAuditor_contact_first_name(pstmt.getString(13));
				this.setAuditor_contact_middle_name(pstmt.getString(14));
				this.setAuditor_contact_last_name(pstmt.getString(15));
				this.setAuditor_contact_title(pstmt.getString(16));
				this.setAuditor_contact_phone_num(pstmt.getString(17));
				this.setAuditor_contact_phone_ext_num(pstmt.getString(18));
				this.setAuditor_contact_fax_num(pstmt.getString(19));
				this.setAuditor_contact_email(pstmt.getString(20));
				this.setMyErrorMsg(pstmt.getString(22));
	...
	public ArrayList<String> fillStatesList() throws Exception{
		Connection conn= null;
		CallableStatement pstmt=null;
    	...
    	try {
			...
			pstmt = conn.prepareCall("{call qass_get_state_codes(?)}");
	...
	public int updateAuditFirmObject(AuditFirm auditFirm, String userName , String auditFirmType) throws SQLException, NamingException{
		Connection conn= null;
		CallableStatement pstmt=null;
		int myResult =0;
    	...
    	try {
    		conn = (new DBConnection()).getConnection();
			 ...
			 pstmt = conn.prepareCall("{call qass_update_uii(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			
			
			 auditFirm.setAudit_firm_phone_num(formatPhoneNumbers(auditFirm.getAudit_firm_phone_num()));
			 auditFirm.setAuditor_contact_phone_num(formatPhoneNumbers(auditFirm.getAuditor_contact_phone_num()));
			 auditFirm.setAuditor_contact_phone_ext_num(formatPhoneNumbers(auditFirm.getAuditor_contact_phone_ext_num()));
			 auditFirm.setAuditor_contact_fax_num(formatPhoneNumbers(auditFirm.getAuditor_contact_fax_num()));
			 
			 pstmt.setString(1, auditFirm.getAudit_firm_id().trim());
			 pstmt.setString(2, auditFirm.getAudit_firm_name().trim());
			 pstmt.setString(3, auditFirm.getAudit_firm_tax_id().trim());
			 pstmt.setString(4, auditFirmType.trim());
			 pstmt.setString(5, auditFirm.getAudit_firm_address_line_1().trim());
			 pstmt.setString(6, auditFirm.getAudit_firm_address_line_2().trim());
			 pstmt.setString(7, auditFirm.getAudit_firm_city().trim());
			 pstmt.setString(8, auditFirm.getAudit_firm_state().trim());
			 pstmt.setString(9, auditFirm.getAudit_firm_zip_code().trim());
			 pstmt.setString(10,auditFirm.getAudit_firm_zip_code_ext().trim());
			 pstmt.setString(11,auditFirm.getAudit_firm_phone_num().trim());
			 pstmt.setString(12,auditFirm.getAuditor_contact_first_name().trim());
			 pstmt.setString(13,auditFirm.getAuditor_contact_middle_name().trim());
			 pstmt.setString(14,auditFirm.getAuditor_contact_last_name().trim());
			 pstmt.setString(15,auditFirm.getAuditor_contact_title().trim());
			 pstmt.setString(16,auditFirm.getAuditor_contact_phone_num().trim());
			 pstmt.setString(17,auditFirm.getAuditor_contact_phone_ext_num().trim());
			 pstmt.setString(18,auditFirm.getAuditor_contact_fax_num().trim());
			 pstmt.setString(19,auditFirm.getAuditor_contact_email().trim());
			 pstmt.setString(20,userName);
			 pstmt.registerOutParameter(21, Types.VARCHAR);
			 myResult = pstmt.executeUpdate();
			
			 this.setMyErrorMsg(pstmt.getString(21));
    	} catch (SQLException e) {
			e.printStackTrace();
		}finally
    	{
	...
	public int insertAuditFirmObject(AuditFirm auditFirm, String userName , String auditFirmType) throws SQLException, NamingException{
		Connection conn= null;
		CallableStatement pstmt=null;
		int myResult =0;
    	...
    	try {
    		conn = (new DBConnection()).getConnection();
			 pstmt = conn.prepareCall("{call qass_insert_uii(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			 ...
			 pstmt.setString(1, auditFirm.getAudit_firm_name().trim());
			 pstmt.setString(2, auditFirm.getAudit_firm_tax_id().trim());
			 pstmt.setString(3, auditFirmType.trim());
			 pstmt.setString(4, auditFirm.getAudit_firm_address_line_1().trim());
			 pstmt.setString(5, auditFirm.getAudit_firm_address_line_2().trim());
			 pstmt.setString(6, auditFirm.getAudit_firm_city().trim());
			 pstmt.setString(7, auditFirm.getAudit_firm_state().trim());
			 pstmt.setString(8, auditFirm.getAudit_firm_zip_code().trim());
			 pstmt.setString(9,auditFirm.getAudit_firm_zip_code_ext().trim());
			 pstmt.setString(10,auditFirm.getAudit_firm_phone_num().trim());
			 pstmt.setString(11,auditFirm.getAuditor_contact_first_name().trim());
			 pstmt.setString(12,auditFirm.getAuditor_contact_middle_name().trim());
			 pstmt.setString(13,auditFirm.getAuditor_contact_last_name().trim());
			 pstmt.setString(14,auditFirm.getAuditor_contact_title().trim());
			 pstmt.setString(15,auditFirm.getAuditor_contact_phone_num().trim());
			 pstmt.setString(16,auditFirm.getAuditor_contact_phone_ext_num().trim());
			 pstmt.setString(17,auditFirm.getAuditor_contact_fax_num().trim());
			 pstmt.setString(18,auditFirm.getAuditor_contact_email().trim());
			 pstmt.setString(19,userName);
			 pstmt.registerOutParameter(20, Types.CHAR);
			 pstmt.registerOutParameter(21, Types.VARCHAR);
			 
			 myResult = pstmt.executeUpdate();
			 
			 auditFirm.setAudit_firm_id(pstmt.getString(20));
			 auditFirm.setMyErrorMsg(pstmt.getString(21));
    	} catch (SQLException e) {
			e.printStackTrace();
		}finally
    	{
